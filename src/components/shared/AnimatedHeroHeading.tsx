...
export const AnimatedHeroHeading: React.FC<AnimatedHeroHeadingProps> = ({ words }) => {
  return (
    <div className="-mt-4 md:-mt-6 font-dela text-3xl md:text-5xl lg:text-6xl uppercase text-primary leading-[1.15] mb-8 tracking-tight flex flex-wrap justify-center gap-x-4 gap-y-2 lg:gap-y-4">
      {words.map((word, i) => (
