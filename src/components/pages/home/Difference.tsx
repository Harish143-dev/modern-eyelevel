...
const Difference = () => {
  return (
    <section className="pt-12 md:pt-16 pb-10 px-4 bg-forest-deep relative overflow-hidden">
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3  gap-6 ">
          ...
          >
            ...
            <h3 className="font-dela text-xl text-white mb-4">Built from the client side</h3>
