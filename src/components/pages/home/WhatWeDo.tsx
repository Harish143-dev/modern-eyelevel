      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 md:mb-24">
          ...
          >
            ...
            <span className="text-primary">EyeLevel is built to <WavyUnderline className="mb-6 text-primary">grow</WavyUnderline></span>
          </motion.h2>
        </div>
          ...
          >
            ...
            >
              <p className="text-lg md:text-xl font-bricolage leading-relaxed text-foreground">
                EyeLevel Growth Studio is a digital marketing agency in Chennai that runs strategy, performance, content and AI as one connected system. Not three vendors. One studio.
              </p>
            </motion.div>
            ...
            >
              <div className="p-6 md:p-8 border-l-4 border-primary bg-primary/5 rounded-r-2xl relative overflow-hidden">
                <p className="font-dela text-xl md:text-2xl text-primary leading-tight relative z-10 italic">
                  "We're not your agency. We're the marketing team you always wanted to hire."
                </p>
              </div>
            </motion.div>
          </motion.div>
