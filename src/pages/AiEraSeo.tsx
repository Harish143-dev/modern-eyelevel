      ...
      <section className="px-4 sm:px-10 md:px-20 py-20 bg-background relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-3 gap-6 w-full">
          ...
          >
            ...
            <Bot className="w-10 h-10 text-foreground mb-6 transition-colors duration-300 group-hover:text-primary" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <Cpu className="w-10 h-10 text-foreground mb-6 transition-colors duration-300 group-hover:text-primary" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <Code className="w-10 h-10 text-foreground mb-6 transition-colors duration-300 group-hover:text-primary" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <MapPin className="w-10 h-10 text-foreground mb-6 transition-colors duration-300 group-hover:text-primary" />
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <BarChart className="w-10 h-10 text-foreground mb-6 transition-colors duration-300 group-hover:text-primary" />
